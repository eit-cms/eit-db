...
更多能力边界与数据库矩阵请查阅 docs/CAPABILITY_MATRIX.md 与 docs/ARCHITECTURE.md。
...
- v1.0 准入清单：`docs/V1_0_READINESS_CHECKLIST.md`
- 发布门禁：`docs/RELEASE_GATE.md`
- v1.0 升级指南：`docs/MIGRATION_GUIDE_v1_0.md`
- v1.0 API 稳定性清单：`docs/API_STABILITY_v1_0.md`
